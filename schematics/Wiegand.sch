...
<layer number="15" name="Route15" color="17" fill="6" visible="no" active="no"/>
...
<layer number="51" name="tDocu" color="7" fill="2" visible="no" active="no"/>
<layer number="52" name="bDocu" color="3" fill="2" visible="no" active="no"/>
